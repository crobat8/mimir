...
import Western from "../img/WesternWashingtonUniversitySeal.png"
import Whatcom from "../img/Whatcom_CC_Logo.jpg"
import FireBase from "../img/reactfirebase.png"
const About = () =>{
    return(
        <div className="AboutPage">
            ...
            <Fact
                title="What I can do"
                information="My main skill set is focused on web developement primarily in back
